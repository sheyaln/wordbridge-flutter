...
List<BundledSymbolPack> bundledSymbolPacks({AssetBundle? bundle}) => [
  // Generated by tools/fetch_symbols.dart and searched first, because it is
  // the only pack guaranteed to cover the shipped vocabulary. It draws from
  // the sets below, so its attribution is per-symbol and lives in its
