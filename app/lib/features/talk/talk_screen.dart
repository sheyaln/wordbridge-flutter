...
class TalkScreenState extends State<TalkScreen> with WidgetsBindingObserver {
  ...
  /// Neither is a sentence somebody else built on this board to demonstrate.
  ///
          ...
          children: [
                          ...
                          builder: (context, box) {
                            final grid = AbsorbPointer(
                              ...
                              child: GridSurface(
                                ...
                                onPairHold: _onCaregiverGesture,
                                pointAt: _pointAt,
            ...
            Positioned.fromRect(
              ...
              child: CornerHoldTarget(
                ...
                onTriggered: _onCaregiverGesture,
              ),
            ),
          ],
        ),
...
class _UtteranceBarView extends StatelessWidget {
  ...
  /// A partner is demonstrating, so nothing selected right now is being
  /// recorded as this user's practice.
  ///
  /// Said in the one piece of chrome that is fixed height. The bar is the only
